...
The repository's paper workflow compiles this source, uploads the PDF as a CI artifact, and publishes the validated PDF at \texttt{paper/bytetoken\_paper.pdf} on the main branch. Intermediate LaTeX build files are not committed.
